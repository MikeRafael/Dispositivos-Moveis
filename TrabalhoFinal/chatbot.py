    ...
    def __init__(self, nome):
        try:
            ...
            with open(nome+'.json','w') as memoria:
                memoria.write('[[["Will", "Alfredo"], {"oi": "Ol\u00ef\u00bf\u00bd, qual o seu nome?", "tchau": "tchau", "abrir youtube": "executar https://www.youtube.com/", "abrir chrome": "executar \"C:\\Program Files\\Google\\Chrome\\Application\\chrome.exe\""}]')
            memoria = open(nome+'.json','r')
        self.nome = nome
